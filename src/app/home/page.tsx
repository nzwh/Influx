...
import LandingNav from '@/src/app/components/navigators/HomeNav';
...
export default function Register() {
  return (
    <main className="flex flex-col w-screen h-screen">
      ...
      <div className="flex flex-col bg-cover bg-center bg-no-repeat bg-[url('/root/home.jpg')] rounded-l-lg h-full aspect-square p-10 justify-center items-center">
