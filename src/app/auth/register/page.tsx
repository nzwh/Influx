      ...
      <div className="flex justify-center items-center w-screen h-screen">
        <div className="bg-white rounded-lg p-0 flex flex-row h-[32rem] w-[56rem]">
          ...
          <div id="Right div" className="p-10 h-[32rem] w-[95rem]">
            <h6 className="text-black font-bold text-2xl tracking-tighter leading-4 pb-2">Register an account</h6>
            ...
            <form action="/">
              <div className="flex flex-row gap-3 w-full items-center pt-3">
                  <div className="flex flex-col w-full">
                      ...
                      <div className="flex flex-row bg-white rounded-[0.25rem] pt-1 h-8">
                          ...
                          <input type="text" placeholder="Enter first name" className="w-full text-[0.7rem] bg-gray-100 rounded-r-[0.25rem] p-2 tracking-tighter" required></input>
                      </div>
                  </div>
                  <div className="flex flex-col w-full">
                      ...
                      <div className="flex flex-row bg-white rounded-[0.25rem] pt-1 h-8">
                          <Image className="w-7 bg-gray-300 rounded-l-[0.25rem] p-2" src="/icons/b-term.svg" alt="Input Icon" width={10} height={10} />
                          <input type="text" placeholder="Enter last name" className="w-full text-[0.7rem] bg-gray-100 rounded-r-[0.25rem] p-2 tracking-tighter" required></input>
                      </div>
                  </div>
              </div>
              ...
              <div className="flex flex-row bg-white rounded-[0.25rem] pt-1 h-8">
                ...
                <input type="text" placeholder="Enter username" className="w-full text-[0.7rem] bg-gray-100 rounded-r-[0.25rem] p-2 tracking-tighter" required></input>
              </div>
              ...
              <div className="flex flex-row bg-white rounded-[0.25rem] pt-1 h-8">
                ...
                <input type="email" placeholder="Enter email address" className="w-full text-[0.7rem] bg-gray-100 rounded-r-[0.25rem] p-2 tracking-tighter" required></input>
              </div>
              ...
              <div className="flex flex-row bg-white rounded-[0.25rem] pt-1 h-8">
                ...
                <input type="text" placeholder="Enter contact number" className="w-full text-[0.7rem] bg-gray-100 rounded-r-[0.25rem] p-2 tracking-tighter" required></input>
              </div>
