    ...
    <div className="fixed top-0 left-0 w-screen h-screen">
      <nav className="bg-white // h-12 w-full // flex flex-row justify-between items-center // border-b-2 px-[12%] fixed z-30">
        ...
        <section className="flex flex-row items-center gap-2">
          ...
          <span className="" onClick={handleToggleDropDown}>
            <Image className="rounded-full ml-2" src="/avatars/temp.jpg" alt="Profile" width={24} height={24} data-dropdown-toggle="dropdownInformation"/>
          </span>
        </section>
      </nav>
