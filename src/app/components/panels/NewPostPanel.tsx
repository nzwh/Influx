...
const NewPostPanel: React.FC<Props> = ({ onPostRecieve }) => {
  ...
  return (
		<main>
    <section onClick={handleCreatePostPopupOpen} className="bg-white flex flex-row w-full justify-between rounded-sm py-2 px-4 cursor-pointer shadow-xl hover:shadow-2xl transition-shadow duration-400">
